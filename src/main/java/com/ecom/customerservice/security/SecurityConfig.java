...
public class SecurityConfig {
    ...
    public UserDetailsService userDetailsService(DataSource dataSource) {
        ...
        manager.setAuthoritiesByUsernameQuery("SELECT u.username, ur.role FROM users u JOIN user_roles ur ON u.id = ur.user_id WHERE u.username = ?");
        return manager;
    }
...
//        return args -> {
//            UserDetails user1 = User.withUsername("naresh")
